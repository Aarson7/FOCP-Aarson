...
#7
with open(r'C:\Users\aarso\OneDrive\Desktop\info.txt', 'r') as file:
    for line in file:
        print(line,end='')
...
#10
with open(r'C:\Users\aarso\OneDrive\Desktop\info.txt', 'a') as file:
    file.write("Aarson Subba says hello....\n")
age = 19
with open(r'C:\Users\aarso\OneDrive\Desktop\info.txt', 'a') as file:
    file.write(str(age) + "\n")
# This is a text file
